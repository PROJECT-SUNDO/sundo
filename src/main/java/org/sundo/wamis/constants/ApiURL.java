...
public class ApiURL {
    ...
    // 강수량 관측소 상세
    public static final String RF_OBSERVATORY_DETAIL = "https://api.hrfco.go.kr/FD14A031-75BC-4BB4-B271-E68E7470A8BF/rainfall/info.json";

    // 수위 + 유량 관측소 상세
    public static final String WL_FLW_OBSERVATORY_DETAIL = "https://api.hrfco.go.kr/FD14A031-75BC-4BB4-B271-E68E7470A8BF/waterlevel/info.json";
    ...
    // 전체 10분 수위 + 유량 데이터
    public static final String ALL_WATER_LEVEL_FLOW = "https://api.hrfco.go.kr/FD14A031-75BC-4BB4-B271-E68E7470A8BF/waterlevel/list/10M.json";

    // 최근 10분 강수량 데이터 (1건)
    public static final String RCT_PRECIPITATION = "https://api.hrfco.go.kr/FD14A031-75BC-4BB4-B271-E68E7470A8BF/rainfall/list/10M/10184100.json";


    // 최근 10분 수위 + 유량 데이터 (1건)
    public static final String RCT_WATER_LEVEL_FLOW = "https://api.hrfco.go.kr/FD14A031-75BC-4BB4-B271-E68E7470A8BF/waterlevel/list/10M/1018683.json";
