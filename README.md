...
- **프로젝트 필요성**
    - **비전** : 효율적인 수자원관리를 위한 수자원 통합 관리 정보 시스템 도입 필요
    - 수자원 통합 관리 정보 시스템 구축
...
- 개발자
  ...
  |  개발자  | 깃허브 | 역할분담                                                            | 
  |-----------|----------|-----------------------------------------------------------------|
  | 은진 | [GitHub](https://github.com/3un3un) | 관측소, 강수량/수위/유량 REST API 호출 및 데이터 처리, 목록 관측정보 날짜 조회, 대시보드 기능 및 구현 |
  | 형경 | [GitHub](https://github.com/yhg1024) | 목록 관측소 정보검색, 관측소 상세정보 팝업, 목록출력, 페이지네이션, 대시보드 기능 구현 |
  | 예지 | [GitHub](https://github.com/Yeji-Yoon) | 목록 등록/수정/삭제, 엑셀 저장, api 강수량 파트 불러오기, 대시보드 기능 구현 |
  | 윤희 | [GitHub](https://github.com/yunii118) | 지도 표시 및 레이어 전환, 거리/면적 측정 기능, 지도 줌인/줌아웃 기능, 인덱스맵 및 축적 표시, 지도 사이드바 관측소 노출, 관측소 환경설정, 대시보드 기능 구현  |
  | 지은 | [GitHub](https://github.com/dkumylove) | 지도 마커 표시, 마커 선택 관측소 팝업, 지도 저장, 레이어 범례, 대시보드 기능 구현, 깃허브 관리 |
...
[한강수자원관리종합플랫폼Ⅱ_TEAMSUNDO_PPT.pdf](https://github.com/PROJECT-SUNDO/sundo/blob/common/file/%ED%95%9C%EA%B0%95%EC%88%98%EC%9E%90%EC%9B%90%EA%B4%80%EB%A6%AC%EC%A2%85%ED%95%A9%ED%94%8C%EB%9E%AB%ED%8F%BC%E2%85%A1_%EC%84%A0%EB%8F%84.pdf)
